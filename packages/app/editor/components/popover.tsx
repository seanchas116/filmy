...
export const PopoverContent = tw(Popover.Content)`
  bg-white rounded-lg overflow-hidden border border-gray-200 text-xs text-gray-900 shadow-xl p-3
`;
...
>((props, ref) => {
  return (
    ...
    >
      <path d="M0,0 L8,8 L16,0" className="fill-white stroke-gray-200" />
    </svg>
  );
});
